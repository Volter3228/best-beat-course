        ...
        <div className='col s12 l10 m-0'>
          <div className='row white-text text-bold'>
            <div className='col s12 m4'>
              ...
              <button className='yellow-button'>{t('1.when-btn')}</button>
            </div>
            <div className='col s12 m4'>
              <h6 className='subtitle'>{t('1.where')}</h6>
              <button className='yellow-button'>{t('1.where-btn')}</button>
            </div>
            <div className='col s12 m4'>
              <h6 className='subtitle'>{t('1.orgs')}</h6>
              <button className='yellow-button'>{t('1.orgs-btn')}</button>
            </div>
          </div>
        </div>
      </div>
